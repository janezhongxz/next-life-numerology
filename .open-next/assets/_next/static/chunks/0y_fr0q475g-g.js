...
**阶段定位：** ${"天赋养育"===f?"成长关键期，原生能量的保护比任何成就都重要。":"赛道选择"===f?"学业和早期职业探索的黄金期，试错成本最低。":"黄金实战"===f?"土星回归前的立身之本，是建立事业和关系的核心期。":"天命整合"===f?'从"为生存而战"转向"为使命而活"的关键转折。':'从"被疗愈者"成为"疗愈者"。'}
