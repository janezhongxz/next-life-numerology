...
**阶段定位：** ${"天赋养育"===p?"成长关键期，原生能量的保护比任何成就都重要。":"赛道选择"===p?"学业和早期职业探索的黄金期，试错成本最低。":"黄金实战"===p?"土星回归前的立身之本，是建立事业和关系的核心期。":"天命整合"===p?'从"为生存而战"转向"为使命而活"的关键转折。':'从"被疗愈者"成为"疗愈者"。'}

**【A 阶段核心】** ${"天赋养育"===p?"能量保护 - 保护孩子的原生能量不被制约压制":"赛道选择"===p?'恐惧选择识别 - 选专业是基于"我想要"还是"我害怕"':"黄金实战"===p?"职业锚点 - 找到你稳定输出的核心能力区":"天命整合"===p?"从生存到使命 - 重新回答人生下半场的方向":'外部权威 - 从"被疗愈者"成为"疗愈者"'}

**【B 关键机制】** ${"天赋养育"===p?"学习节律 - 找到孩子的能量高峰期":"赛道选择"===p?"专业匹配与试错策略 - 用100小时验证法":"黄金实战"===p?"通道天赋最大化 - 找到你最高效的表达→行动路径":"天命整合"===p?"人生下半场方向检视 - 用轮回交叉视角审视":"身体智慧与疗愈分享 - 用身体感知替代大脑分析"}

**【C 偏离修正】** ${"天赋养育"===p?"情绪疏导与边界 - 稳定回应 > 立即满足":"赛道选择"===p?"独立决策边界 - 独立决策 ≠ 冲动决断":"黄金实战"===p?"抗压机制 - 区分真实压力和想象的压力":"天命整合"===p?'去制约边界 - 识别"我应该"的声音是谁的期待':'放下控制边界 - 区分"帮助"和"控制"'}

**【D 输出型策略】** ${"天赋养育"===p?'亲子沟通句式 - "我理解你感到..."':"赛道选择"===p?"社交与资源积累 - 建立弱关系网络":"黄金实战"===p?"关系能量管理 - 识别消耗型和滋养型关系":"天命整合"===p?"影响力构建 - 用专业输出建立影响力":"智慧传承 - 写下来/录下来，你的故事就是最好的教材"}

**【心理建设】**
- ${"天赋养育"===p?"学习是为了理解世界，不是为了比较":"赛道选择"===p?"选择没有对错，只有适合和成长":"黄金实战"===p?"你的价值不取决于职位或收入":"天命整合"===p?"你不需要向任何人证明自己":"你的经验是宝贵的传承资产"}
- ${"天赋养育"===p?"失败是探索的一部分，不是能力的定义":"赛道选择"===p?"大学是探索期，不是定型期":"黄金实战"===p?"休息不是懒惰，是战略投资":"天命整合"===p?"后半生可以跟前半生完全不同":"帮助他人的同时也是在疗愈自己"}
- ${"天赋养育"===p?"你的价值不取决于成绩或表现":"赛道选择"===p?"你不需要现在就确定一生的事业":"黄金实战"===p?"可以追求成功，但不要用健康换":"天命整合"===p?"真正的成熟是接纳自己的全部":"年龄带给你的是智慧，不是限制"}
...
${u.length>0?u.map((e,t)=>`- ☐ 针对缺失数 **${e}** 的具体练习`).join("\n"):"- ☐ 今年没有缺失数绑定，专注于发挥优势"}
- ☐ 至少完成1次"阶段核心"相关的深度反思
- ☐ 建立/优化你的"关键机制"执行路径
...
你的 **${r}** 主轨决定了你终将走向【】；你的 **${i}** 触发机制决定了你会在【】变得强或失控；你的 **${n}** 行动方式决定了你要用【】来验证选择。
